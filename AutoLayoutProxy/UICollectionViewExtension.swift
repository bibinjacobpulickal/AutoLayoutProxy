...
public extension UICollectionView {
    ...
    func register<CellClass: NSObject>(_ cell: CellClass.Type) {
        register(cell, forCellWithReuseIdentifier: cell.identifier)
    }
    
    func dequeue<CellClass: NSObject>(_ class: CellClass.Type, for indexPath: IndexPath, configure: ((CellClass) -> Void)) -> UICollectionViewCell {
