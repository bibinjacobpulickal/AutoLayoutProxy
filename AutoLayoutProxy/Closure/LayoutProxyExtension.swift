...
public extension LayoutProxy {
    ...
    func fillView(_ view: AutoLayoutable, inset: EdgeInsetConvertible = 0) {
    ...
    func alignCenters(inset: EdgeInsetConvertible = 0, to view: AutoLayoutable) {
